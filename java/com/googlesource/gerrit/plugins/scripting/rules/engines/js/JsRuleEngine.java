...
class JsRuleEngine implements RuleEngine {
  ...
  private Collection<SubmitRecord> runScriptInSandbox(String script, Change change, ChangeData cd)
    ...
    System.out.println("jsScript= [[" + script + "]]");
    Object resultingResult = v8.executeJSFunction("submit_rule", v8Change, v8Requirements);
    ...
    System.out.println(resultingResult);
    v8.release();
    System.out.println("Duration: " + (System.nanoTime() - start));
    if (okRequirements.requirements.isEmpty()) {
      return ImmutableList.of(notReadyRequirements);
    } else if (notReadyRequirements.requirements.isEmpty()) {
  ...
  private V8Object prepareChangeObject(final V8 v8, Change change, ChangeData cd)
    ...
    // change.findVotes("Verified") -> array of votes
